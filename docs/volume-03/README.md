...
- [AI-ENG-G — Model Selection: Capability Fit, Deployment Fit & Failure Tolerance](./ai-eng-g-model-selection.md)
...
- [AI-ENG-H — Model Adaptation: Fine-Tuning, LoRA, Preference Tuning & Distillation](./ai-eng-h-model-adaptation.md)
...
- [AI-ENG-I — Regression Control: Model Registries, Rollouts & Behavioral Drift](./ai-eng-i-regression-control.md)
