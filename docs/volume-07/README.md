...
- [AI-ENG-S — Production Pathologies: Hallucination, Malformed Output & Runaway Behavior](./ai-eng-s-production-pathologies.md)
...
- [AI-ENG-T — Boundary Defense: Prompt Injection, Data Leakage & Tenant Isolation](./ai-eng-t-boundary-defense.md)
...
- [AI-ENG-U — AI Supply Chain Security: Models, Datasets, Dependencies & Tool Surfaces](./ai-eng-u-ai-supply-chain-security.md)
...
- [AI-ENG-V — Resource Abuse, Cost Bombs & Unbounded Consumption](./ai-eng-v-resource-abuse-cost-bombs-unbounded-consumption.md)
