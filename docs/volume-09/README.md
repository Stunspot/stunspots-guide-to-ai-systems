...
- [AI-ENG-Z — Strategic Telemetry: Traces, Tokens, Latency & Semantic Drift](./ai-eng-z-strategic-telemetry.md)
...
- [AI-ENG-AA — Evals Architecture: Ground Truth, Golden Sets & Regression Tests](./ai-eng-aa-evals-architecture.md)
...
- [AI-ENG-AB — Verification Artifacts: Auditability, Reproducibility & Evidence Trails](./ai-eng-ab-verification-artifacts.md)
