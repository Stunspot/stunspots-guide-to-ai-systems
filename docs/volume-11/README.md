...
- [AI-ENG-AF — AI Product Architecture: Use-Case Selection, Workflow Fit & Value Design](./ai-eng-af-ai-product-architecture.md)
...
- [AI-ENG-AG — Adoption Systems: Training, Feedback Loops & Change Management](./ai-eng-ag-adoption-systems.md)
...
- [AI-ENG-AH — Build, Buy, Open Source & Vendor Strategy](./ai-eng-ah-build-buy-open-source-vendor-strategy.md)
